# https://github.com/mli/gluon-tutorials-zh/blob/master/utils.py
...
def train(train_data, test_data, net, loss, trainer, ctx, num_epochs, print_batches=None):
    ...
    for epoch in range(num_epochs):
        train_loss, train_acc, n, m = 0.0, 0.0, 0, 0
        if isinstance(train_data, mx.io.NDArrayIter) or \
           isinstance(train_data, mx.io.MXDataIter) :
            train_data.reset()
        start = time()
        ...
        #))
        print("Epoch %d. Loss: %.3f, Time %.1f sec" % ( epoch, train_loss/n, time() - start) )
